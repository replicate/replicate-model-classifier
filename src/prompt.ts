...
export function generatePrompt({
  ...
  - inputTypes: An array of the types of inputs the model accepts. Allowable values are "text", "image", "audio", "speech", "video", "3d"
  - outputTypes: An array of the types of outputs the model returns. Allowable values are "text", "image", "audio", "speech", "video", "3d"
